export const metadata = {
  ...
  description: 'Miele Washer error code E3 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Miele Washer Error Code E3</h1>
      <p>Error code E3 troubleshooting for Miele Washer.</p>
      <section>
        <h2>What It Means</h2>
