export const metadata = {
  ...
  description: 'Miele Dryer error code E1 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Miele Dryer Error Code E1</h1>
      <p>Error code E1 troubleshooting for Miele Dryer.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code E1 indicates a fault in the Miele Dryer system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
