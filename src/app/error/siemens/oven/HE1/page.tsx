export const metadata = {
  ...
  description: 'Siemens Oven error code HE1 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Siemens Oven Error Code HE1</h1>
      <p>Error code HE1 troubleshooting for Siemens Oven.</p>
      <section>
        <h2>What It Means</h2>
