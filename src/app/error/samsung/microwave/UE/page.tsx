...
export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1 style={{fontSize: '2.2rem', fontWeight: 'bold', marginBottom: '15px'}}>Samsung Microwave Error Code UE</h1>
      <p style={{color: '#94a3b8', marginBottom: '30px'}}>Error code UE troubleshooting for Samsung Microwave.</p>
      <section style={{marginBottom: '30px', background: '#1e293b', padding: '24px', borderRadius: '12px'}}>
        ...
        <p style={{color: '#94a3b8', lineHeight: '1.8'}}>Error code UE indicates a fault in Samsung Microwave.</p>
      </section>
