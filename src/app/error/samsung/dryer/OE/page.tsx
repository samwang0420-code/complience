export const metadata = {
  ...
  description: 'Samsung Dryer error code OE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Samsung Dryer Error Code OE</h1>
      <p>Error code OE troubleshooting for Samsung Dryer.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code OE indicates a fault in the Samsung Dryer system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
