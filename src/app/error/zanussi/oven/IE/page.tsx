export const metadata = {
  ...
  description: 'Zanussi Oven error code IE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Zanussi Oven Error Code IE</h1>
      <p>Error code IE troubleshooting for Zanussi Oven.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code IE indicates a fault in the Zanussi Oven system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
