export const metadata = {
  ...
  description: 'Toshiba Washer error code E5 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Toshiba Washer Error Code E5</h1>
      <p>Error code E5 troubleshooting for Toshiba Washer.</p>
      <section>
        <h2>What It Means</h2>
