export const metadata = {
  ...
  description: 'AEG Oven error code E4 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>AEG Oven Error Code E4</h1>
      <p>Error code E4 troubleshooting for AEG Oven.</p>
      <section>
        <h2>What It Means</h2>
