export const metadata = {
  ...
  description: 'KitchenAid Refrigerator error code IE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>KitchenAid Refrigerator Error Code IE</h1>
      <p>Error code IE troubleshooting for KitchenAid Refrigerator.</p>
      <section>
        <h2>What It Means</h2>
