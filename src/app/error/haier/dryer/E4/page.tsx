export const metadata = {
  ...
  description: 'Haier Dryer error code E4 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Haier Dryer Error Code E4</h1>
      <p>Error code E4 troubleshooting for Haier Dryer.</p>
      <section>
        <h2>What It Means</h2>
