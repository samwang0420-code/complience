export const metadata = {
  ...
  description: 'Haier Washer error code CL troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Haier Washer Error Code CL</h1>
      <p>Error code CL troubleshooting for Haier Washer.</p>
      <section>
        <h2>What It Means</h2>
