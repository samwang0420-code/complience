export const metadata = {
  ...
  description: 'Daewoo Washer error code E7 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Daewoo Washer Error Code E7</h1>
      <p>Error code E7 troubleshooting for Daewoo Washer.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code E7 indicates a fault in the Daewoo Washer system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
