export const metadata = {
  ...
  description: 'Sharp Washer error code DE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Sharp Washer Error Code DE</h1>
      <p>Error code DE troubleshooting for Sharp Washer.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code DE indicates a fault in the Sharp Washer system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
