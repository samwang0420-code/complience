export const metadata = {
  ...
  description: 'Sharp Washer error code E2 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Sharp Washer Error Code E2</h1>
      <p>Error code E2 troubleshooting for Sharp Washer.</p>
      <section>
        <h2>What It Means</h2>
