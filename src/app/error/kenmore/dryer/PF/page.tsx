export const metadata = {
  ...
  description: 'Kenmore Dryer error code PF troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Kenmore Dryer Error Code PF</h1>
      <p>Error code PF troubleshooting for Kenmore Dryer.</p>
      <section>
        <h2>What It Means</h2>
        <p>Error code PF indicates a fault in the Kenmore Dryer system.</p>
      </section>
      <section>
        <h2>How to Fix</h2>
        <ol>
