export const metadata = {
  ...
  description: 'Kenmore Oven error code LE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Kenmore Oven Error Code LE</h1>
      <p>Error code LE troubleshooting for Kenmore Oven.</p>
      <section>
        <h2>What It Means</h2>
