export const metadata = {
  ...
  description: 'Hisense Microwave error code HE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Hisense Microwave Error Code HE</h1>
      <p>Error code HE troubleshooting for Hisense Microwave.</p>
      <section>
        <h2>What It Means</h2>
