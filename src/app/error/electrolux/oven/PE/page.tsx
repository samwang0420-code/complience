export const metadata = {
  ...
  description: 'Electrolux Oven error code PE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Electrolux Oven Error Code PE</h1>
      <p>Error code PE troubleshooting for Electrolux Oven.</p>
      <section>
        <h2>What It Means</h2>
