export const metadata = {
  ...
  description: 'Kenmore Dishwasher error code LE1 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Kenmore Dishwasher Error Code LE1</h1>
      <p>Error code LE1 troubleshooting for Kenmore Dishwasher.</p>
      <section>
        <h2>What It Means</h2>
