export const metadata = {
  ...
  description: 'Frigidaire Dryer error code E5 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Frigidaire Dryer Error Code E5</h1>
      <p>Error code E5 troubleshooting for Frigidaire Dryer.</p>
      <section>
        <h2>What It Means</h2>
