export const metadata = {
  ...
  description: 'Siemens Microwave error code HE2 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Siemens Microwave Error Code HE2</h1>
      <p>Error code HE2 troubleshooting for Siemens Microwave.</p>
      <section>
        <h2>What It Means</h2>
