export const metadata = {
  ...
  description: 'Sharp Dishwasher error code E9 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Sharp Dishwasher Error Code E9</h1>
      <p>Error code E9 troubleshooting for Sharp Dishwasher.</p>
      <section>
        <h2>What It Means</h2>
