export const metadata = {
  ...
  description: 'Amana Dishwasher error code UE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Amana Dishwasher Error Code UE</h1>
      <p>Error code UE troubleshooting for Amana Dishwasher.</p>
      <section>
        <h2>What It Means</h2>
