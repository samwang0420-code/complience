export const metadata = {
  ...
  description: 'Whirlpool Oven error code TE troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Whirlpool Oven Error Code TE</h1>
      <p>Error code TE troubleshooting for Whirlpool Oven.</p>
      <section>
        <h2>What It Means</h2>
