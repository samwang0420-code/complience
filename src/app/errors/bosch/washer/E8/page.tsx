export const metadata = {
  ...
  description: 'Bosch Washer error code E8 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Bosch Washer Error Code E8</h1>
      <p>Error code E8 troubleshooting for Bosch Washer.</p>
      <section>
        <h2>What It Means</h2>
