export const metadata = {
  ...
  description: 'Toshiba Dishwasher error code HE1 troubleshooting guide with step-by-step fix instructions.'
}

export default function Page() {
  return (
    <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
      <h1>Toshiba Dishwasher Error Code HE1</h1>
      <p>Error code HE1 troubleshooting for Toshiba Dishwasher.</p>
      <section>
        <h2>What It Means</h2>
