      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            ...
            <a href="#installation" className="flex items-center justify-center px-8 py-4 bg-white border border-slate-200 text-slate-900 rounded-xl text-lg font-bold hover:bg-slate-50 transition-all active:scale-[0.98]">
              View Installation
            </a>
          </div>
          
          <div className="space-y-4">
            <p className="text-sm font-semibold text-slate-400 uppercase tracking-widest">Trusted by 2,000+ businesses on:</p>
            <div className="flex flex-wrap gap-8 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
              <img src="https://upload.wikimedia.org/wikipedia/commons/9/93/Wordpress_Blue_logo.png" alt="WordPress" className="h-6" />
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Shopify_Logo.png/640px-Shopify_Logo.png" alt="Shopify" className="h-6" />
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Wix.com_website_logo.svg/1200px-Wix.com_website_logo.svg.png" alt="Wix" className="h-6" />
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Squarespace_logo.svg/1280px-Squarespace_logo.svg.png" alt="Squarespace" className="h-6" />
            </div>
          </div>
        </motion.div>
